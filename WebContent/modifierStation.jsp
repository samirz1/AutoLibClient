    ...
    <div class="col-xs-12">
        ...
        <div class="page">
            ...
            <div class="row">
                ...
                <h2>Modification des informations relative à la station n°${station.getIdStation()}</h2>
				    ...
				    <div class="form-group">
                   		<div class="col-sm-offset-2 col-sm-10">
                   			...
                   			<button
								...
								onclick="loc_conf('Attention, vous êtes sur le point de supprimer complètement cette station !','./controleurStation?action=suppression&id=${station.getIdStation()}');">
